...
const mark = <Svg style={{marginLeft: 10}} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<Path d="M15 5L8 12L15 19" stroke="#54595D" strokeWidth="2" strokeLinecap="round"/>
</Svg>
    ...
    <SafeAreaView style={styles.postContainer}>
        <ScrollView style={styles.scrollInfo}>
            <View style={styles.navigation}>
                <Text style={styles.collection}>{ route.params.collection }{ mark }</Text>
                <Text style={styles.creator}>{ route.params.creator }</Text>
                <Text style={styles.owner}>Owned by <Text style={styles.green}>{ route.params.owner }</Text></Text>
            ...
            <View style={styles.imageBottom}>
                ...
                <View style={styles.infoBlock}>
                    <View style={styles.infoBlockFlex}>
                        ...
                        <Text style={styles.greenText2}>{ route.params.contract }</Text>
                    </View>
                    <View style={styles.infoBlockFlex}>
                        <Text  style={styles.nameText2}>Blochckain</Text>
                        <Text  style={styles.greenText2}>{ route.params.blockchain }</Text>
                    </View>
                    <View style={styles.infoBlockFlex}>
                        <Text  style={styles.nameText2}>Token standard</Text>
                        <Text  style={styles.greenText2}>{ route.params.standard }</Text>
                    </View>
                </View>
        </ScrollView>
