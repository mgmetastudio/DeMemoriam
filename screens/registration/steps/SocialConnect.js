...
const SocialConnect = (props) => {
  return (
    <View style={styles.wrapper}>
      ...
      <View>
            <Text style={styles.title2}>Let's write history together</Text>
      </View>
      <View>
            <Text style={styles.paragraph}>With a help of AI, create customised NFTs of yourself to let the world remember your whole life’s story</Text>
      </View>
